; (function () {
  ...
  function DrawingCanvas(parentContainer) {
    this.height = document.getElementById('drawing-canvas-container').getBoundingClientRect().height - 20;
    this.width = document.getElementById('drawing-canvas-container').getBoundingClientRect().width - 15;
